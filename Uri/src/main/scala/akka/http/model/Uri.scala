...
import akka.scalajs.Charset
import scala.annotation.tailrec
import scala.collection.{ immutable, mutable, LinearSeqOptimized }
import scala.collection.immutable.LinearSeq
import org.parboiled2.{ CharUtils, CharPredicate, ParserInput }
...
object Uri {
  ...
  private[http] def decode(string: String, charset: Charset, ix: Int): String = akka.scalajs.decodeURIComponent(string)
